<div>
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="title">
            ...
            {{ $isEdit ? 'Edit Materia' : 'Create New Materia' }}
        </x-slot>
        ...
        <x-slot name="content">
            <div class="w-full flex flex-col gap-2">
               <div class="flex flex-col gap-2">
                   <div class="w-full">
                        <x-label value="Name" />
                        <x-input type="text" class="w-full" wire:model="materia.name" />
                        <x-input-error for='materia.name' />
                    </div>
               </div>
            </div>
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-button wire:click="submit" wire:loading.attr="disabled" class="disabled:opacity-25">
                {{ $isEdit ? 'Edit Materia' : 'Create Materia' }}
            </x-button>
        </x-slot>
