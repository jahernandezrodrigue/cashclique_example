<div>
    @livewire('temporal.alumnos.create-alumno')
    <x-slot name="header">
    ...
    <div class="block justify-between items-center p-4 mx-4 mt-4 mb-6 bg-white rounded-2xl shadow-xl shadow-gray-200 lg:p-5 sm:flex">
        <div class="mb-1 w-full">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">All alumnos</h1>
            </div>
            <div class="block items-center sm:flex md:divide-x md:divide-gray-100">
                <form class="mb-4 sm:pr-3 sm:mb-0" action="#" method="GET">
                    ...
                    <div class="relative mt-1 sm:w-64 xl:w-96">
                        <input type="text" name="email" id="products-search"
                            ...
                            placeholder="Search for alumnos" wire:model="search">
                    </div>
                </form>
                <div class="flex items-center w-full sm:justify-end">
                    ...
                    <x-button wire:click="$emit('createAlumno')" wire:loading.attr="disabled" class="disabled:opacity-25">
                        Add Alumno
                    </x-button>
                </div>
            </div>
                            ...
                            @foreach ($alumnos as $item)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                        <button type="button" data-modal-toggle="product-modal" wire:click="$emit('editAlumno', {{$item->id}})"
